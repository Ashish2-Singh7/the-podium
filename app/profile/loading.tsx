                            ...
                            <div className="flex-1 mt-4 md:mt-0">
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                    ...
                                    <div className="flex items-center space-x-3 mt-4 md:mt-0">
                                        <div className="h-10 bg-gradient-to-r from-purple-200 via-purple-300 to-purple-200 dark:from-purple-800 dark:via-purple-700 dark:to-purple-800 animate-shimmer bg-[length:200%_100%] rounded-lg w-32"></div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                            {[1, 2, 3, 4, 5].map((item) => (
                                <div key={item} className="text-center space-y-2">
                                    <div className="h-8 bg-gradient-to-r from-purple-200 via-purple-300 to-purple-200 dark:from-purple-800 dark:via-purple-700 dark:to-purple-800 animate-shimmer bg-[length:200%_100%] rounded w-12 mx-auto"></div>
                            ...
                            {[1, 2, 3].map((item) => (
                                <div key={item} className="flex space-x-4 p-6 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                                    ...
                                    <div className="flex-1 space-y-3">
                                        {/* Category and Date */}
                                        <div className="flex items-center space-x-2">
                                            <div className="h-5 bg-gradient-to-r from-purple-200 via-purple-300 to-purple-200 dark:from-purple-800 dark:via-purple-700 dark:to-purple-800 animate-shimmer bg-[length:200%_100%] rounded-full w-20"></div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="h-4 bg-gradient-to-r from-purple-200 via-purple-300 to-purple-200 dark:from-purple-800 dark:via-purple-700 dark:to-purple-800 animate-shimmer bg-[length:200%_100%] rounded w-20"></div>
                                        </div>
                                    </div>
                                </div>
                            ))}
