...
import { AlignLeft, Save, Tag, Type, Upload } from 'lucide-react';
...
interface ArticleFormData {
    ...
    content: string;
    category: string;
    tags: string; // This is a comma-separated string from the input field
    featuredImage: string; // This can be a URL, a base64 string, or an empty string
}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
                    ...
                    <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                        <div className="flex items-center space-x-4">
                            <div
                                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors bg-gray-300 duration-200`}
                            >
                        ...
                        <div className="flex items-center space-x-3">
                            <button
                                ...
                                className={`bg-blue-600  ${pubLoading ? "bg-gray-600 text-gray-400" : "bg-blue-600 cursor-pointer text-white"} px-6 py-2 rounded-lg hover:${pubLoading ? "bg-gray-700 " : "bg-blue-700 "} transition-colors duration-200 flex items-center space-x-2`}
                            >
                                {pubLoading ? <div role="status" className='mr-3'>
                                ...
                                <span className='hidden sm:block'>{pubLoading ? "Publishing..." : "Publish"}</span>
                            </button>
                        </div>
                    </div>
